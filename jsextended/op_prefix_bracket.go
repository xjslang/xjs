...
func ParsePrefixBracketOp(p *parser.Parser) (node *js.PrefixBracketOp, err error) {
	node = &js.PrefixBracketOp{}
...
func PrintPrefixBracketOp(pr *printer.Printer, node *js.PrefixBracketOp) error {
